...
class ParentWindow(Frame): #making our own frame class for our own purpose
    ...
    def sourceDir(self):
        ...
        #The .insert method will insert the user selection to the sourece_dir Entry
    ...
    def exit_program(self):
        ...
        #telss python to terminate root.mainloop and all widgets inside the GUI window
        root.destroy()
